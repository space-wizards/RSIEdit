...
The json at [Assets/repo-licenses](https://github.com/space-wizards/RSIEdit/blob/master/Editor/Assets/repository-licenses.json) dictates which license it will use by default for that repository.  
